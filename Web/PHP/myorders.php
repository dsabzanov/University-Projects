    ...
    <body>
        <div class="container">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-item nav-link" href="myorders.php">My Orders<span class="sr-only">(current)</span></a>
                            </div>
                        </div>
                    </div>
                </nav>
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <?php 
                        $query1 = "SELECT * FROM orders WHERE orders.user_id = ".$_SESSION['userid']. " ORDER BY orders.order_id DESC";
                        ...
                        $query2 = "SELECT orders.order_id, orders.completed, products.display_name, products.price, products.size, orders.quantity, orders.quantity * price AS ExtPrice FROM products INNER JOIN orders ON products.product_id = orders.product_id WHERE orders.user_id =" . $_SESSION['userid']. " AND orders.order_id=". $greatestId;
